 ...
 * Size: 20 px
 * Bpp: 1
 * Opts: --bpp 1 --size 20 --no-compress --stride 1 --align 1 --font MaterialIcons-Regular.ttf --range 60135,60136,60134,61595 --font fa-solid-900.ttf --range 57699,61549,61956,61957 --format lvgl -o custom_icons_20.c
 ******************************************************************************/
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0xfe, 0x1f, 0x81, 0xf8, 0x1f, 0x81, 0xf8, 0x1f,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 155, .adv_w = 320, .box_w = 12, .box_h = 14, .ofs_x = 4, .ofs_y = 4},
    {.bitmap_index = 176, .adv_w = 360, .box_w = 22, .box_h = 15, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 218, .adv_w = 360, .box_w = 22, .box_h = 15, .ofs_x = 0, .ofs_y = 0}
};
...
static const uint16_t unicode_list_0[] = {
    0x0, 0x983, 0x984, 0x985, 0xf0a, 0xf38, 0x10a1, 0x10a2
};
